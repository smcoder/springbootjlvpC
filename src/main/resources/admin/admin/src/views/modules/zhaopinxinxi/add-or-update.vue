...
<el-col :span="12">
    <el-form-item  v-if="type!='info'"  label="企业地址" prop="address">
    <el-input v-model="ruleForm.address"
placeholder="企业地址" clearable></el-input>
</el-form-item>
<div v-else>
    <el-form-item v-if="ruleForm.address" label="企业地址" prop="address">
        <el-input v-model="ruleForm.address"
...
<el-col :span="12">
    <el-form-item  v-if="type!='info'"  label="截止时间" prop="endTime">
<el-date-picker type="date" placeholder="截止时间" v-model="ruleForm.endTime" style="width: 100%;"></el-date-picker>
</el-form-item>
<div v-else>
    <el-form-item v-if="ruleForm.endTime" label="截止时间" prop="endTime">
        <el-date-picker type="date" placeholder="截止时间" v-model="ruleForm.endTime" style="width: 100%;" readonly></el-date-picker>
    </el-form-item>
</div>
</el-col>
...
export default {
  ...
  methods: {
    ...
    if(o=='shengyurenshu'){
    this.ruleForm.shengyurenshu = obj[o];
    continue;
}
    if(o=='endTime'){
