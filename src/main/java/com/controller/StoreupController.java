...
public class StoreupController {
    ...
    public R delete(@RequestBody Map<String,Object> map,HttpServletRequest request){
        map.put("userid",(Long)request.getSession().getAttribute("userId"));
        storeupService.deleteByMap(map);
        //storeupService.deleteBatchIds(Arrays.asList(refid));
        return R.ok();
    }
